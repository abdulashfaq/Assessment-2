  ...
  <head>
	...
	<div class="bgcontainer">
            ...
            <a class="navbar-brand" href="index.jsp">
                    <img src="https://pbs.twimg.com/profile_images/1412430664620822530/SlhUV9_5_400x400.jpg" style="width : 90px; height : 60px" />
            </a>
            </div>
            <div class="collapse navbar-collapse navsearch" id="navbarSupportedContent">
                <form name ="myform" onsubmit="return valid()" action="${pageContext.request.contextPath}/operation" class="form-inline my-2 my-lg-0 ml-auto" method="get">
		...
		<div class="container">
			...
			<div class="row justify-content-center ">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section"><b>Employee Registration</b></h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
			      	...
			      	<div class="row justify-content-center py-md-5">
			      		<div class="col-lg-9">
			      			<div class="social-wrap">
				      			<h3 class="mb-3 text-center">Sign up with Employee details</h3>
			          	</div>
							<form action="${pageContext.request.contextPath}/operation" name="myForm" onsubmit="return valid()" class="signup-form" method="post">
										<div class="row">
											
												<div class="col-md-6">
													<div class="form-group">
								      			<label class="label" for="name">Employee ID</label>
											...
											<div class="col-md-6">
												<div class="form-group">
							      			<label class="label" for="name">Date of Joining</label>
							      			<input type="date" class="form-control" name="DOJ" required>
							      		</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
							      			<label class="label" for="email">Department</label><br/>
							      			<select style="width:250px;"name="Dept" class="form-select" id="Dept" required> 
											...
											<div class="col-md-12">
												<div class="form-group">
						            	<label class="label" for="password">Grade</label><br/>
							              <select   style="width:250px;" class="form-group" name="Grade" id="Grade"  required> 
											...
											<div class="col-md-12">
												<div class="form-group">
						            	<label class="label" for="password">Gross Salary</label>
						              <input type="number" class="form-control" name="GrossSal" required>
						            </div>
											</div>
											</div>
											<div class="col-md-12">
						            	...
						            	<input type="hidden" name="form" value="addemployeeOperation">
       									<input type="submit" class="btn btn-primary submit p-3" value="Submit" >
						            </div>
											</div>
